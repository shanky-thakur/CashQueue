...
public class UsersContoller {
    ...
    // create a user (method : post) (end-point : "/Users/create") (body : {"userName" : "..", "password" : ".."})
    @PostMapping("/create")
    ...
    public Users updateUser(@PathVariable ObjectId id, @RequestBody Users newUser) {
        return services.update(id, newUser);
    }
}
